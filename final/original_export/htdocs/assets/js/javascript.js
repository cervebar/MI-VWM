$(document).ready(function() {
	$("#all").click(function () {
		...
		$('#aff').prop('checked',checked); 
		$('#aspt').prop('checked',checked);  
		$('#ulh').prop('checked',checked);  
		$('#bsos').prop('checked',checked);  
		$('#bsoa').prop('checked',checked);  
		$('#zca').prop('checked',checked);  
		$('#rms').prop('checked',checked);  
		$('#co').prop('checked',checked);  
		$('#sct').prop('checked',checked);  
		$('#hsct').prop('checked',checked);  
		$('#scoa').prop('checked',checked);  
	});
