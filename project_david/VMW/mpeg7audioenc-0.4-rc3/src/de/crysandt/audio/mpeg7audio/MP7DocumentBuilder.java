...
import de.crysandt.audio.mpeg7audio.mci.*;
...
*/		
   ...
   // private boolean checked=false;
	...
	public void receivedMsg(Msg msg) {
		...
		} else if (msg instanceof MsgLogAttackTime) { //RP 29/04/09 activate LogAttackTime
			assert msgLAT == null;
			msgLAT = (MsgLogAttackTime) msg;
		} else if (msg instanceof MsgSpectralCentroid) { //RP 29/04/09 activate SpectralCentroid
			assert msgSC == null;
			msgSC = (MsgSpectralCentroid) msg;
		} else if (msg instanceof MsgTemporalCentroid) { //RP 29/04/09 activate TemporalCentroid
			assert msgTC == null;
